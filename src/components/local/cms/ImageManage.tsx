...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"; // Re-import Select
        ...
        <Card>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2 border p-4 rounded-lg bg-red-50/50">
                    <Label htmlFor="collection-delete" className="text-lg font-semibold text-red-700">
                ...
                <h3 className="text-xl font-semibold">Image List ({filteredImages.length})</h3>
                    ...
                    >
                        {filteredImages.map((img) => (
                            ...
                            >
                                ...
                                <p className="text-sm font-medium text-center truncate">{img.name}</p>
                                <p className="text-xs text-gray-500 text-center">({img.collection})</p>
