...
export default function ImageManager() {
    ...
    const handleSaveChanges = async () => {
        ...
        const currentActiveImages = images.filter((img) => !img.isDeleted && !img.isNew);
        const actions: Array<{
            type: string;
            path?: string;
        }> = [];
        ...
        originalImages.forEach((original) => {
            ...
            if (!isStillPresent) {
                const remotePath = original.originalPath.replace("/content/images/", "public/content/images/");
        ...
        try {
            ...
            console.warn("If this error relates to GitHub, ensure the required access is configured for the API route.");
        } finally {
            setIsSaving(false);
        }
    };
